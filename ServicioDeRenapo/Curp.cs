...
namespace Renapo
{
    ...
    public class Curp
    {
        ...
        public  string Generar(string nombres, string paterno, string materno, Sexo sexo, DateTime fechaNacimiento, Estado estado)
        {
            // Aplicar filtros
            ...
            // Pre CURP
            string sexoString = sexo == Sexo.Mujer ? "M" : "H";
            var preCURP = $"{uno}{dos}{tres}{cuatro}{fecha}{sexoString}{estadoCodigo}{catorce}{quince}{dieciseis}";
